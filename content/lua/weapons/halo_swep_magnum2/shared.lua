...
SWEP.Gun = ("halo_swep_magnum2") -- must be the name of your swep but NO CAPITALS!
SWEP.Category				= "Halo" --Category where you will find your weapons
SWEP.Author				= "Sixx"
SWEP.Contact				= "eve-gaming.com"
SWEP.Instructions				= "LMB: Fire"
SWEP.PrintName				= "M6G Magnum"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-2.76, 0, 0.079)
SWEP.IronSightsAng = Vector(2.48, -3.583, 0)
